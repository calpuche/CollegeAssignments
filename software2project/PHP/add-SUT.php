...
print "<h4>Add System Under Test</h4>";
print "<!-- System Name -->\n";
...
print "<input type='text' id='systemName' name='systemName' placeholder='Insert System Name Here' class='form-control' required='true'>\n";
print "</div>\n";
print "</div>\n";
...
print "<div class='controls'>\n";
print "<input type='text' id='operatingSystem' name='operatingSystem' placeholder='Insert Operating System Here' class='form-control' required='true'>\n";
print "</div>\n";
print "</div>\n";
...
print "<div class='controls'>\n";
print "<input type='text' id='hardwareDescription' name='hardwareDescription' placeholder='Insert Hardware Description Here' class='form-control' required='true'>\n";
print "</div>\n";
print "</div>\n";
...
print "<div class='controls'>\n";
print "<input type='text' id='systemDescription' name='systemDescription' placeholder='Insert System Description Here' class='form-control' required='true'>\n";
print "</div>\n";
print "</div>\n";
...
print "<div class='controls'>\n";
print "<input type='text' id='location' name='location' placeholder='Insert Location Here' class='form-control' required='true'>\n";
print "</div>\n";
print "</div>\n";

print "<br>";
print "<button class='btn btn-primary' >Submit New SUT</button>\n";
print "</div>\n";
print "</div>";
print "</form>";
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $query = "INSERT INTO systemsUnderTest VALUES(null,'" . $systemName ."','" . $operatingSystem . "','" . $hardwareDescription . "','" . $sytemDescription . "','" .$location . "')";
