...
echo '<i class="fa fa-table"></i> Tests</div>';
...
print "<!-- Test ID -->\n";
print "<form name='UpdateTest' form action='update-test.php' class='form-horizontal' method='post'>";
print "<div class='form-group'>";
print "<div class='control-group'>\n";
print "<label class='control-label'  for='testID'>Enter Test ID to Update:</label>\n";
print "<div class='controls'>\n";
print "<input type='number' id='testID' name='testID' placeholder='Enter Test ID To Update Here' class='form-control' required='true'>\n";
print "</div>\n";
print "</div>\n";
print "<br>";
print "<button class='btn btn-primary' >Submit Test ID</button>\n";
print "</div>\n";
print "</div>";
print "</form>";
