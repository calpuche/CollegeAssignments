...
echo '<span class="nav-link-text">Systems Under Test</span>';
echo '</a>';
...
echo '<i class="fa fa-table"></i> Systems Under Test</div>';
...
echo '<th>Hardware Description</th>';
...
$sql= "select sutID, systemName, operatingSystem, hardwareDescription, systemDescription, location from systemsUnderTest";
$rs = $db ->Execute($sql);
...
if (!$rs) {
    ...
    while (!$rs->EOF) {
        ...
        echo '<td>'.$hardwareDescription.'</td>';
...
print "<h4>Update SUT</h4>";
print "<!-- SUT ID -->\n";
print "<form name='UpdateSUT' form action='update-SUT.php' class='form-horizontal' method='post'>";
print "<div class='form-group'>";
print "<div class='control-group'>\n";
print "<label class='control-label'  for='sutID'>Enter SUT ID to Update:</label>\n";
print "<div class='controls'>\n";
print "<input type='number' id='sutID' name='sutID' placeholder='Enter SUT ID To Update Here' class='form-control' required='true'>\n";
print "</div>\n";
print "</div>\n";
print "<br>";
print "<button class='btn btn-primary' >Submit SUT ID</button>\n";
print "</div>\n";
print "</div>";
print "</form>";
